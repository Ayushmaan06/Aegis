...
var chunk_RLUV56AY_exports = {};
__export(chunk_RLUV56AY_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_RLUV56AY_exports);
...
[Context: getDmmf]`;
    super((0, import_chunk_V52TJFHT.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_SLNABFCV.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
