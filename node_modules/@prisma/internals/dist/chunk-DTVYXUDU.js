...
var chunk_DTVYXUDU_exports = {};
__export(chunk_DTVYXUDU_exports, {
  GetConfigError: () => GetConfigError,
  getConfig: () => getConfig
});
module.exports = __toCommonJS(chunk_DTVYXUDU_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        return import_chunk_QKG5SKXX.prismaSchemaWasm.get_config(params);
      },
      (e) => ({
        type: "wasm-error",
