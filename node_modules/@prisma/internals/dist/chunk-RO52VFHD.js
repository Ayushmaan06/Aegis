...
var chunk_RO52VFHD_exports = {};
__export(chunk_RO52VFHD_exports, {
...
module.exports = __toCommonJS(chunk_RO52VFHD_exports);
...
var import_chunk_2OMW2BHO = require("./chunk-2OMW2BHO.js");
var import_chunk_Z7YL2PST = require("./chunk-Z7YL2PST.js");
var import_chunk_DTVYXUDU = require("./chunk-DTVYXUDU.js");
var import_chunk_SUYXIGXQ = require("./chunk-SUYXIGXQ.js");
var import_chunk_QKG5SKXX = require("./chunk-QKG5SKXX.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(() => {
      import_chunk_QKG5SKXX.prismaSchemaWasm.debug_panic();
    });
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_2OMW2BHO.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_2OMW2BHO.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_QKG5SKXX.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_DTVYXUDU.getConfig)({ datamodel: schemaResult.schemas });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_SUYXIGXQ.getDMMF)({
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_Z7YL2PST.mergeSchemas)({ schemas: schemaContext.schemaFiles });
        const options2 = {
          datamodel,
